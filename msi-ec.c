...
static struct msi_ec_conf CONF33 __initdata = {
	...
	.cpu = {
		.rt_temp_address       = 0x68,
		.rt_fan_speed_address  = 0xc9,
		.rt_fan_speed_base_min = 0xF4, // 1%
		.rt_fan_speed_base_max = 0x55, // 150%
		.bs_fan_speed_address  = MSI_EC_ADDR_UNSUPP,
		.bs_fan_speed_base_min = 0x00,
		.bs_fan_speed_base_max = 0x0f,
	},
					   ...
					   char *buf)
{
	...
	if ((rdata < min(conf.cpu.rt_fan_speed_base_min, conf.cpu.rt_fan_speed_base_max) ||
	    rdata > max(conf.cpu.rt_fan_speed_base_min, conf.cpu.rt_fan_speed_base_max)))
		return -EINVAL;
